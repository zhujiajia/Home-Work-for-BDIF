...
ts.plot(price, main="The trend of CRIX")
...
ts.plot(Return,main="The log returns of CRIX")
adf.test(Return)#p-value = 0.01, ret is stationary

acf(Return)
pacf(Return)
auto.arima(Return)# ARIMA(5,2,0)
